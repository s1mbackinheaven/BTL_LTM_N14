...
public class ClientConnectionManager {
    ...
    /**
     * Lấy tất cả các OutputStream của client đang kết nối
     * Dùng để broadcast message đến toàn bộ người chơi
     */
    public Iterable<ObjectOutputStream> getAllClientStreams() {
