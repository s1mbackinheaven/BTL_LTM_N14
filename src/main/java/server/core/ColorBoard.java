...
public class ColorBoard {
     ...
     * Lưu ý: Chỉ ẩn tạm thời, cần reset sau khi hiển thị cho client
     */
    public void revealOnlyThreeColors() {
        ...
        // TODO: Cần revisibility sau khi client nhận được thông tin
        // Hoặc tự động reset sau lượt đóset
        // Hiện tại: visibility sẽ bị giữ nguyên cho đến khi reset manually
    }
